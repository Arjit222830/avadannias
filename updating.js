...
router.post('/',async (req,res)=>{
    ...
    res.send({link:'/admin/6MayMMExW08NiAq92aMWKSNjWANjsxzhnjaskdhoijwasmx',message:"New Update has been updated successfully"});
});
...
router.delete('/', async (req,res)=>{
   ...
   res.send({link:'/admin/6MayMMExW08NiAq92aMWKSNjWANjsxzhnjaskdhoijwasmx',message:"An update is removed"});
});
