...
const {Quiz,validate}= require('./quiz');
const middleware= require('./middleware');
const mongoose =require('mongoose');

router.get('/submit',async (req,res)=>{
    res.send({link:'/quiz',message1:'You answer ',message2:' out of ',message3:' questions correctly'});
});
...
router.delete('/', async (req,res)=>{
   ...
   res.send({link:'/admin/6MayMMExW08NiAq92aMWKSNjWANjsxzhnjaskdhoijwasmx',message:"A question has been removed"});
});
